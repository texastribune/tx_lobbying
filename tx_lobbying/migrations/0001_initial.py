...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('raw', django.contrib.postgres.fields.hstore.HStoreField(null=True)),
                ...
                ('client_num', models.PositiveSmallIntegerField(help_text=b'Client ID for lobbyist. The client number assigned to this client on the most recently filed registration.', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_date', models.DateField()),
                ('year', models.IntegerField()),
                ('address', models.ForeignKey(help_text=b'The address the lobbyist listed for themself.', to='tx_lobbying.Address')),
